...
function Settings() {
  ...
  const getLanguage = async () => {
    await axios
      .get(`http://api.speakbetter.hng.tech/v1/user/profile/${userId}`, config) // Used my login details ID here as well
      .then((response) => {
  ...
  const changeLanguage = (selected) => {
    ...
    axios
      .post(
        'http://api.speakbetter.hng.tech/v1/user/profile/update',
